function onCreate()
	for i = 0, getProperty('unspawnNotes.length')-1 do
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'LordNotes' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'noteTypes/LordNotes');
